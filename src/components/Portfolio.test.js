...
test('renders a featured project with tags, a demo link, and a GitHub link', () => {
  ...
  expect(container.querySelector('a[href="https://example.com/demo"]')).toBeInTheDocument();
  expect(
    container.querySelector('a[href="https://github.com/example/featured-project"]')
  ).toBeInTheDocument();
});
...
test('scrolls to the top when the zoom link is clicked', () => {
  ...
  fireEvent.click(container.querySelector('a[href="/projects/featured-project"]'));
